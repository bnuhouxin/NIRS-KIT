function varargout = NIRS_Matrix_ttest2(varargin)
% NIRS_MATRIX_TTEST2 MATLAB code for NIRS_Matrix_ttest2.fig
%      NIRS_MATRIX_TTEST2, by itself, creates a new NIRS_MATRIX_TTEST2 or raises the existing
%      singleton*.
%
%      H = NIRS_MATRIX_TTEST2 returns the handle to a new NIRS_MATRIX_TTEST2 or the handle to
%      the existing singleton*.
%
%      NIRS_MATRIX_TTEST2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_MATRIX_TTEST2.M with the given input arguments.
%
%      NIRS_MATRIX_TTEST2('Property','Value',...) creates a new NIRS_MATRIX_TTEST2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_Matrix_ttest2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_Matrix_ttest2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_Matrix_ttest2

% Last Modified by GUIDE v2.5 23-Nov-2019 14:56:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_Matrix_ttest2_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_Matrix_ttest2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_Matrix_ttest2 is made visible.
function NIRS_Matrix_ttest2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_Matrix_ttest2 (see VARARGIN)

% Choose default command line output for NIRS_Matrix_ttest2
...
% UIWAIT makes NIRS_Matrix_ttest2 wait for user response (see UIRESUME)
% uiwait(handles.NIRS_Matrix_ttest2);


% --- Outputs from this function are returned to the command line.
function varargout = NIRS_Matrix_ttest2_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes during object creation, after setting all properties.
function NIRS_REST_ttest2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to NIRS_Matrix_ttest2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes when user attempts to close NIRS_Matrix_ttest2.
function NIRS_REST_ttest2_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to NIRS_Matrix_ttest2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
