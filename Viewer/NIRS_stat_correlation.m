function varargout = NIRS_stat_correlation(varargin)
% NIRS_STAT_CORRELATION MATLAB code for NIRS_stat_correlation.fig
%      NIRS_STAT_CORRELATION, by itself, creates a new NIRS_STAT_CORRELATION or raises the existing
%      singleton*.
%
%      H = NIRS_STAT_CORRELATION returns the handle to a new NIRS_STAT_CORRELATION or the handle to
%      the existing singleton*.
%
%      NIRS_STAT_CORRELATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_STAT_CORRELATION.M with the given input arguments.
%
%      NIRS_STAT_CORRELATION('Property','Value',...) creates a new NIRS_STAT_CORRELATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_stat_correlation_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_stat_correlation_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_stat_correlation

% Last Modified by GUIDE v2.5 13-Nov-2019 19:05:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_stat_correlation_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_stat_correlation_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_stat_correlation is made visible.
function NIRS_stat_correlation_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_stat_correlation (see VARARGIN)

% Choose default command line output for NIRS_stat_correlation
...
function varargout = NIRS_stat_correlation_OutputFcn(hObject, eventdata, handles) 
...
% hObject    handle to NIRS_stat_correlation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes when user attempts to close NIRS_stat_correlation.
