...
% Last Modified by GUIDE v2.5 11-Dec-2020 17:10:18
...
if get(handles.falff,'value') == 1
    ...
    set(handles.entirelow,'enable','on');
    set(handles.entirehigh,'enable','on');
else
    set(handles.isfAlff_z,'value',0);
    set(handles.isfAlff_z,'enable','off');
    
    set(handles.entirelow,'enable','off');
    set(handles.entirehigh,'enable','off');
end



function entirelow_Callback(hObject, eventdata, handles)
% hObject    handle to entirelow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of entirelow as text
%        str2double(get(hObject,'String')) returns contents of entirelow as a double


% --- Executes during object creation, after setting all properties.
function entirelow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to entirelow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function entirehigh_Callback(hObject, eventdata, handles)
% hObject    handle to entirehigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of entirehigh as text
%        str2double(get(hObject,'String')) returns contents of entirehigh as a double


% --- Executes during object creation, after setting all properties.
function entirehigh_CreateFcn(hObject, eventdata, handles)
% hObject    handle to entirehigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
