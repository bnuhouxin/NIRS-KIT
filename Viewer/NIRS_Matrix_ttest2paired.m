function varargout = NIRS_Matrix_ttest2paired(varargin)
% NIRS_MATRIX_TTEST2PAIRED MATLAB code for NIRS_Matrix_ttest2paired.fig
%      NIRS_MATRIX_TTEST2PAIRED, by itself, creates a new NIRS_MATRIX_TTEST2PAIRED or raises the existing
%      singleton*.
%
%      H = NIRS_MATRIX_TTEST2PAIRED returns the handle to a new NIRS_MATRIX_TTEST2PAIRED or the handle to
%      the existing singleton*.
%
%      NIRS_MATRIX_TTEST2PAIRED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_MATRIX_TTEST2PAIRED.M with the given input arguments.
%
%      NIRS_MATRIX_TTEST2PAIRED('Property','Value',...) creates a new NIRS_MATRIX_TTEST2PAIRED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_Matrix_ttest2paired_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_Matrix_ttest2paired_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_Matrix_ttest2paired

% Last Modified by GUIDE v2.5 13-Nov-2019 21:00:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_Matrix_ttest2paired_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_Matrix_ttest2paired_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_Matrix_ttest2paired is made visible.
function NIRS_Matrix_ttest2paired_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_Matrix_ttest2paired (see VARARGIN)

% Choose default command line output for NIRS_Matrix_ttest2paired
...
function varargout = NIRS_Matrix_ttest2paired_OutputFcn(hObject, eventdata, handles) 
...
if ischar(inpath1)
    ...
    subfiles=dir(fullfile(inpath1,'*.txt'));
    sub01=load(fullfile(inpath1,subfiles(1).name));
    chn=1:length(sub01); 
    str_chn=num2str(chn);
    set(handles.mask_channels,'string',str_chn);
...
% hObject    handle to NIRS_Matrix_ttest2paired (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% =========================================================================
...
% =========================================================================
% --- Executes when user attempts to close NIRS_Matrix_ttest2paired.
