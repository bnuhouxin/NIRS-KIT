function varargout = NIRS_stat_anova(varargin)
% NIRS_STAT_ANOVA MATLAB code for NIRS_stat_anova.fig
%      NIRS_STAT_ANOVA, by itself, creates a new NIRS_STAT_ANOVA or raises the existing
%      singleton*.
%
%      H = NIRS_STAT_ANOVA returns the handle to a new NIRS_STAT_ANOVA or the handle to
%      the existing singleton*.
%
%      NIRS_STAT_ANOVA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_STAT_ANOVA.M with the given input arguments.
%
%      NIRS_STAT_ANOVA('Property','Value',...) creates a new NIRS_STAT_ANOVA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_stat_anova_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_stat_anova_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_stat_anova

% Last Modified by GUIDE v2.5 23-Nov-2019 14:48:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_stat_anova_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_stat_anova_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_stat_anova is made visible.
function NIRS_stat_anova_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_stat_anova (see VARARGIN)

% Choose default command line output for NIRS_stat_anova
...
% UIWAIT makes NIRS_stat_anova wait for user response (see UIRESUME)
% uiwait(handles.NIRS_stat_anova);


% --- Outputs from this function are returned to the command line.
function varargout = NIRS_stat_anova_OutputFcn(hObject, eventdata, handles) 
...
% hObject    handle to NIRS_stat_anova (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes when user attempts to close NIRS_stat_anova.
