...
% Last Modified by GUIDE v2.5 28-Jul-2021 15:43:31
...
if isempty(name)||isempty(thres)
    ...
    delete(handles.NID_Input_SpatialMap)
end
...
% --- Executes when user attempts to close NID_Input_SpatialMap.
function NID_Input_SpatialMap_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to NID_Input_SpatialMap (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
