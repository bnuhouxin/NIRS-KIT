...
nic_info=get(handles.ic_num_caculate,'Userdata');
switch nic_info.method
    case 'PCA'
        numIC_all = NID_ic_NO_caculate(handles,nic_info.data);
    case 'User Input'
        numIC_all.oxy = nic_info.data;
        numIC_all.dxy = nic_info.data;
        numIC_all.total = nic_info.data;
end
