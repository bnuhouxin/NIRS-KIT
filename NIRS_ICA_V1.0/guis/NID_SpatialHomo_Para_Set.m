...
% Last Modified by GUIDE v2.5 28-Jul-2021 15:39:56
...
delete(handles.NID_SptialHomo_ParameterSetting)
...
homo_obj=findobj('Tag','NIRS_ICA_Denoiser');
OFIChandles = guihandles(homo_obj);
data.thres = thres;
set(OFIChandles.homo,'Userdata',data)
delete(handles.NID_SptialHomo_ParameterSetting)
...
% --- Executes when user attempts to close NID_SptialHomo_ParameterSetting.
function NID_SptialHomo_ParameterSetting_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to NID_SptialHomo_ParameterSetting (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
