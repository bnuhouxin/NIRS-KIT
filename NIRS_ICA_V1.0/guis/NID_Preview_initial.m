function NID_Preview_initial(NIDhandles,handles)
%% ȥ����Ԥ�����桰NID_Preview����ʼ������
%%
handlesAll.NIDHandles = NIDhandles;
handlesAll.SRHandles = handles;
set(handles.NID_Preview,'Userdata',handlesAll)
% �û����еĳɷ֣������ɷ֣��б�
...
% set path information and load data
    ...
    colortemp = load([defaultSetDir 'mycolorTable.mat']);           % ������ɫ�ļ���Ϊmulti-chģʽ׼��
    data.color = colortemp.mycolorTable;
    
    set(handles.nirs_data_timeserial,'UserData',data);
    
    % ��ʾ�û�ѡ�еĳɷ�
    set(handles.edit28,'String',selectedIC)
    % ��ȡICAȥ����NIRS����
...
%% change color button ��Multi-CH ģʽ������ɫ��������
