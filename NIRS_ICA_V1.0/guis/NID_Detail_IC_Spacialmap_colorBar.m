function NID_Detail_IC_Spacialmap_colorBar(handles)
%% ??????????Detail????????IC????????Map??colorbar
%%
...
set(cb,'XTick',[0.01,1],'XTickLabel',[-y_absmax,y_absmax])
set(cb,'position',[0.46,0.035,0.51,0.025])
