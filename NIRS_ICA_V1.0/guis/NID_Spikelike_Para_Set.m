...
% Last Modified by GUIDE v2.5 28-Jul-2021 16:21:40
...
spk_obj=findobj('Tag','NIRS_ICA_Denoiser');
OFIChandles = guihandles(spk_obj);
data.wins = wins;
data.thres = thres;
data.ma_thres = ma_thres;
set(OFIChandles.spikelike,'Userdata',data)
delete(handles.NID_Spikelike_ParameterSetting)
...
% --- Executes when user attempts to close NID_Spikelike_ParameterSetting.
function NID_Spikelike_ParameterSetting_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to NID_Spikelike_ParameterSetting (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
