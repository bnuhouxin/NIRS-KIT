function NID_Detail_IC_Set_Reserve_icflip(curicNum,DetailHandles,NIDHandles,order)
%%
...
%
% set(DetailHandles.selectic,'String',selectedIC,'Fontweight','bold','FontSize',10)
% 
%% IC fliper
...
%
% button_color = {[0.941,0.941,0.941],[0.941,0.941,0.941],[0.702,0.78,0.1],...
%     [0.0,1,1],[0,1,0]};
