...
[IC_indiv A_indiv W_indiv]=fastica(data,'approach',ap2,...
        'numOfIC',numIC_indiv,'g',ap4,'finetune',ap4,...
        'stabilization','on',...
        'epsilon',ap3,'maxNumIterations',ap1,...
        'lastEig',numIC_indiv,'initGuess', A);
