function varargout = NID_Preview(varargin)
% NID_PREVIEW M-file for NID_Preview.fig
%      NID_PREVIEW, by itself, creates a new NID_PREVIEW or raises the existing
%      singleton*.
%
%      H = NID_PREVIEW returns the handle to a new NID_PREVIEW or the handle to
%      the existing singleton*.
%
%      NID_PREVIEW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NID_PREVIEW.M with the given input arguments.
%
%      NID_PREVIEW('Property','Value',...) creates a new NID_PREVIEW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NID_Preview_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NID_Preview_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NID_Preview

% Last Modified by GUIDE v2.5 04-Nov-2014 10:10:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NID_Preview_OpeningFcn, ...
                   'gui_OutputFcn',  @NID_Preview_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NID_Preview is made visible.
function NID_Preview_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NID_Preview (see VARARGIN)

% Choose default command line output for NID_Preview
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes NID_Preview wait for user response (see UIRESUME)
% uiwait(handles.NID_Preview);


% --- Outputs from this function are returned to the command line.
function varargout = NID_Preview_OutputFcn(hObject, eventdata, handles) 
...
% %initialize
%     %config raw_data
%     set(handles.NID_Preview,'userdata',dataSource);
...
if strcmp(multiviewMode,'Yes')
    ...
    NID_Preview_initial(NIDHandles,handles)
    NID_SR_nirsdata_drawTimeseries(handles)
    NID_SR_nirsdata_drawFreq(handles)
else
end
...
% --- Executes when NID_Preview is resized.
function NID_Preview_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to NID_Preview (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
handlesAll = get(handles.NID_Preview,'Userdata');
