function varargout = NIRS_ICA(varargin)
% NIRS_ICA M-file for NIRS_ICA.fig
%      NIRS_ICA, by itself, creates a new NIRS_ICA or raises the existing
%      singleton*.
%
%      H = NIRS_ICA returns the handle to a new NIRS_ICA or the handle to
%      the existing singleton*.
%
%      NIRS_ICA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_ICA.M with the given input arguments.
%
%      NIRS_ICA('Property','Value',...) creates a new NIRS_ICA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_ICA_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_ICA_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_ICA

% Last Modified by GUIDE v2.5 09-Nov-2023 15:21:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_ICA_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_ICA_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_ICA is made visible.
function NIRS_ICA_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_ICA (see VARARGIN)

% Choose default command line output for NIRS_ICA
...
% UIWAIT makes NIRS_ICA wait for user response (see UIRESUME)
...
function varargout = NIRS_ICA_OutputFcn(hObject, eventdata, handles) 
