function varargout = NIRS_BSS_Detail_of_Source(varargin)
% NIRS_BSS_DETAIL_OF_SOURCE M-file for NIRS_BSS_Detail_of_Source.fig
%      NIRS_BSS_DETAIL_OF_SOURCE, by itself, creates a new NIRS_BSS_DETAIL_OF_SOURCE or raises the existing
%      singleton*.
%
%      H = NIRS_BSS_DETAIL_OF_SOURCE returns the handle to a new NIRS_BSS_DETAIL_OF_SOURCE or the handle to
%      the existing singleton*.
%
%      NIRS_BSS_DETAIL_OF_SOURCE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_BSS_DETAIL_OF_SOURCE.M with the given input arguments.
%
%      NIRS_BSS_DETAIL_OF_SOURCE('Property','Value',...) creates a new NIRS_BSS_DETAIL_OF_SOURCE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_BSS_Detail_of_Source_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_BSS_Detail_of_Source_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_BSS_Detail_of_Source

% Last Modified by GUIDE v2.5 02-Jul-2020 09:03:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_BSS_Detail_of_Source_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_BSS_Detail_of_Source_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_BSS_Detail_of_Source is made visible.
function NIRS_BSS_Detail_of_Source_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_BSS_Detail_of_Source (see VARARGIN)

% Choose default command line output for NIRS_BSS_Detail_of_Source
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes NIRS_BSS_Detail_of_Source wait for user response (see UIRESUME)
% uiwait(handles.NIRS_BSS_Detail_of_Source);


% --- Outputs from this function are returned to the command line.
function varargout = NIRS_BSS_Detail_of_Source_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes when NIRS_BSS_Detail_of_Source is resized.
function NIRS_ICA_Denoiser_Detail_of_IC_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to NIRS_BSS_Detail_of_Source (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% set(handles.show_bl_remove,'Value',0)
% 
% handlesAll = get(handles.NIRS_BSS_Detail_of_Source,'Userdata');
% NIDhandles = handlesAll.NIDHandles;
% 
% icdata = get(handles.ic_data_timeserials,'Userdata');
% targetic = icdata.icnum;
