function varargout = NIRS_BSS_v1(varargin)
% NIRS_BSS_V1 M-file for NIRS_BSS_v1.fig
%      NIRS_BSS_V1, by itself, creates a new NIRS_BSS_V1 or raises the existing
%      singleton*.
%
%      H = NIRS_BSS_V1 returns the handle to a new NIRS_BSS_V1 or the handle to
%      the existing singleton*.
%
%      NIRS_BSS_V1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIRS_BSS_V1.M with the given input arguments.
%
%      NIRS_BSS_V1('Property','Value',...) creates a new NIRS_BSS_V1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NIRS_BSS_v1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NIRS_BSS_v1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NIRS_BSS_v1

% Last Modified by GUIDE v2.5 10-May-2021 10:05:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @NIRS_BSS_v1_OpeningFcn, ...
                   'gui_OutputFcn',  @NIRS_BSS_v1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NIRS_BSS_v1 is made visible.
function NIRS_BSS_v1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NIRS_BSS_v1 (see VARARGIN)

% Choose default command line output for NIRS_BSS_v1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes NIRS_BSS_v1 wait for user response (see UIRESUME)
% uiwait(handles.NIRS_ICA_Denoiser);


% --- Outputs from this function are returned to the command line.
function varargout = NIRS_BSS_v1_OutputFcn(hObject, eventdata, handles) 
